...
(function() {
	...
	var factory = function (exports) {
		...
		exports.fn.emojiDialog = function() {
			...
			var category = ["layemoji", "Twemoji", "Font awesome"];
            ...
            var emojiCategories = ["layemoji", "twemoji", "font-awesome"];
                    ...
                    for (var i = 0; i < pageTotal; i++)
                    {
                        ...
                        for (var x = 0; x < rowNumber; x++)
                        {
                            ...
                            if (typeof emoji !== "undefined" && emoji !== "")
                            {
                                ...
                                if (type === "layemoji")
								{
									var layemojiSrc =  "/layui/images/face/"+ emoji + ".gif";
									img = "<img src=\"" + layemojiSrc + "\" width=\"24\" title=\"twemoji-" + emoji + "\" alt=\"twemoji-" + emoji + "\" class=\"emoji twemoji\" />";
									row += "<a href=\"javascript:;\" value=\":tw-" + emoji + ":\" title=\":lay-" + emoji + ":\" class=\"" + classPrefix + "emoji-btn\">" + img + "</a>";
								}
                                else if (type === "twemoji")
                                {
                                    ...
                                    row += "<a href=\"javascript:;\" value=\":lay-" + emoji + ":\" title=\":lay-" + emoji + ":\" class=\"" + classPrefix + "emoji-btn\">" + img + "</a>";
                                }
